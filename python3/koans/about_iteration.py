...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Extra Credit:
        # Describe in your own words what reduce does: Se le proporciona una función y una lista con los enteros que queremos usar.
        # coge el primer número y el segundo y aplica la función. repite el proceso cogiendo el resultado de los primeros y aplicando 
        # la función junto con el tercero. resultado + siguiente numero. hasta que acaba. lo devuelve en tipo número
